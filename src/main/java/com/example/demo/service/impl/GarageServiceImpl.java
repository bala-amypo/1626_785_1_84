...
//         Optional<Garage> existingOpt = repo.findByGarageName(garage.getGarageName());
...
//         if (garage.getGarageName() != null) {
//             Optional<Garage> gOpt = repo.findByGarageName(garage.getGarageName());
//             if (gOpt.isPresent() && !gOpt.get().getId().equals(id)) {
//                 throw new IllegalArgumentException("already exists");
//             }
//             existing.setGarageName(garage.getGarageName());
//         }
